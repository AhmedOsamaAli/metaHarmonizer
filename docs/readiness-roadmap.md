...
| P1 | Define and obtain owner acceptance for public-beta service objectives | Engineering proposal in `docs/service-level-objectives.md`: 99% monthly availability; dashboard p95 <=1 s/p99 <=2 s; zero controlled-fixture errors; warm harmonization p95 <=60 s; queue/storage safeguards and explicitly pending RPO/RTO. Awaiting named mentor/service-owner approval and review date. |
